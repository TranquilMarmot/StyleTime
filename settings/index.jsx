registerSettingsPage(() => (
  <Page>
    ...
    >
      ...
      <Text bold>
        Q: When the watch starts it doesn&apos;t have the colors I chose,
        but then it switches to them... what&apos;s up with that!
      </Text>
      <Text>
        A: The settings you choose are stored on your phone, and not on the watch itself.
        Because of this, when the watch starts it has to ask the phone for all of the settings.
        Once it gets them, it can change to your chosen colors.
      </Text>
      <Text bold>
      ...
      <Text>
        A: If you want more colors, feel free to email me at nate@moore.codes and
      ...
      <Text>
        A: This watchface is currently only available on the Versa;
        if I have enough time in the future I&apos;ll also make it work on the Ionic.
      </Text>
      <Text bold>
      ...
      <Text>
        ...
        {' '}
        under the MIT license (which means feel free to use it as long as you give me credit!)
